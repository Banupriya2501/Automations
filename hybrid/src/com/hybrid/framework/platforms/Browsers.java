...
public class Browsers {
	...
	public static void Browser() throws BiffException, IOException, WriteException {
		...
		try{
			...
			wbook = Workbook.getWorkbook(new File("/home/selvam/Documents/Excel/Testinput/MerchantRMS1.xls"));
			wwbCopy = Workbook.createWorkbook(new File("/home/selvam/Documents/Excel/Test-result/Reviews.xls"), wbook);
		...
		// Set firefox profile
			...
			System.setProperty("webdriver.gecko.driver","/home/selvam/Documents/jars/geckodriver");
		...
		else if(browser.equalsIgnoreCase("chrome"))
		{
			...
			System.setProperty("webdriver.chrome.driver" , "/home/selvam/Documents/jars/chromedriver (2)" );
