...
class Menupage(lib.BasePage):
    ...
    def sales_menu(self):
        WebDriverWait(self.driver, 25).until(EC.element_to_be_clickable((By.XPATH, './/*[@id="appDrawerAppPanelBody"]/ul/li[3]/a/img')))
        self.driver.find_element_by_xpath(".//*[@id='appDrawerAppPanelBody']/ul/li[3]/a/img").click()
