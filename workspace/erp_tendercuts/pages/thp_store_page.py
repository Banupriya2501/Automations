...
class Thoraipakkampage(lib.BasePage):
    ...
    def vendor_bill(self):
        ...
        time.sleep(0.4)
        self.driver.find_element_by_css_selector("div.o_hidden_input_file.o_hidden > form.o_form_binary_form > input[name=\"ufile\"]").send_keys("/home/banupriya/Documents/Projectionsheet/MRT.xlsx")
    ...
    def zero(self):
        ...
        self.driver.find_element_by_xpath('html/body/div[1]/div/div[2]/div/div/div/div[1]/div[2]/div[3]/div/div[2]/div/div[2]/table/tbody/tr[1]/td[3]').click()
