...
@scenario('test_checkout.feature', 'erp')
def test_login():
    """PlacingOrder_cod."""
    pass
...
@then('login to thoraipakkam store and receive the product<storedate>')
def thoraipakkam(cache,driver,storedate):
    ...
    thoraipakkam_store.vendor_bill()
