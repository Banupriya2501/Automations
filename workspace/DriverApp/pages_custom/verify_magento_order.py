...
class Verifymagento(lib.BasePage):
    ...
    def sales_ordercard(self, orderid, ordertype,paymenttype):
        ...
        response = requests.get("http://staging.tendercuts.in:82/sale_order/order_data?order_id={}".format(orderid), headers={'Authorization': 'Token f3326e5621bcb0448bfeb5d4e70442dba8feee38'})
